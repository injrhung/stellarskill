    ...
    <div style={{ width: "100%", minHeight: "100vh", background: "#07080a", fontFamily: "'Noto Sans TC',sans-serif" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "0.9fr 1.1fr", minHeight: "calc(100vh - 56px)" }}>
        ...
        <div style={{ position: "relative", overflow: "hidden", borderRight: `1px solid ${line}` }}>
          ...
          <div style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%,-50%)", width: 500, height: 500, border: `1px dashed ${line}`, borderRadius: "50%", animation: "spinRev 80s linear infinite" }} />
          <div style={{ position: "absolute", left: "50%", top: "50%", width: 280, height: 280, borderRadius: "50%", background: "radial-gradient(circle at 34% 30%, #dfe2e6, #6d7580 42%, #2a2d32 66%, #0a0b0d 100%)", boxShadow: "inset -32px -24px 78px rgba(0,0,0,.6)", animation: "drift 13s ease-in-out infinite" }} />
          <div style={{ position: "absolute", left: 36, bottom: 32, fontFamily: "'Space Mono',monospace", fontSize: 12, color: inkDim, lineHeight: 1.9 }}>
            <div style={{ color: steel, letterSpacing: ".2em", textTransform: "uppercase" }}>PLANET SURVEY // 行星勘測</div>
        ...
        <div style={{ padding: "52px clamp(32px,4vw,64px)", overflowY: "auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 7, fontFamily: "'Space Mono',monospace", fontSize: 11, color: inkDim, border: `1px solid ${line}`, borderRadius: 2, padding: "5px 12px", letterSpacing: ".06em", textTransform: "uppercase" }}>
              {g.name}
            </span>
          ...
          <div style={{ fontFamily: "'Space Mono',monospace", fontSize: 13, color: steel, letterSpacing: ".1em", marginBottom: 24 }}>{p.en}</div>
          ...
          <div style={{ display: "flex", gap: 1, marginBottom: 32, background: line }}>
            <div style={{ flex: 1, padding: "14px 16px", background: "#08090a" }}>
              ...
              <div style={{ color: steel, fontSize: 17, marginTop: 4 }}>{diffStars(p.difficulty)}</div>
            </div>
            <div style={{ flex: 1, padding: "14px 16px", background: "#08090a" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
            <div style={{ fontFamily: "'Space Mono',monospace", fontSize: 11.5, color: steel, letterSpacing: ".2em", textTransform: "uppercase" }}>▤ TRANSMISSION // {p.type.toUpperCase()} 內容</div>
            <button
              onClick={copy}
